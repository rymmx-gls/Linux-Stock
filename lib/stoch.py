...
def stoch(high, low, close, fast_k=None, slow_k=None, slow_d=None, offset=None, **kwargs):
    ...
    fastk.name = "STOCHF_{}".format(fast_k)
    fastd.name = "STOCHF_{}".format(slow_d)
    slowk.name = "STOCH_{}".format(slow_k)
    slowd.name = "STOCH_{}".format(slow_d)
    ...
    stochdf.name = "STOCH_{}_{}_{}".format(fast_k, slow_k,slow_d)
